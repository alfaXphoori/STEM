...
- เปิดไฟล์แต่ละไฟล์ใน VS Code แล้วใช้ `Open Preview` เพื่อดู Markdown preview
- หากต้องการ ผมสามารถแปลง prompts ให้เป็นไฟล์ `.txt` หรือ `.json` เพื่อส่งให้โมเดลโดยตรง

---

## 📨 ติดต่อ / Issues

- สร้าง Issue ที่: https://github.com/alfaXphoori/STEM/issues

---

ไฟล์นี้ปรับแต่งเพื่อให้อ่านง่ายและใช้งานได้เร็วขึ้น หากต้องการสไตล์อื่น (เช่น ภาษาอังกฤษ, โครงสร้าง README ยาวขึ้น) บอกผมได้เลย
