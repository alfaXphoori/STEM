...
2. เลือกดาวน์โหลด Arduino IDE ตามระบบปฏิบัติการของคุณ (Windows, Mac, Linux)
    <div align="center" style="margin: 2em 0;">
       <img src="Src/0000_download_arduIDE.png" alt="ดาวน์โหลด Arduino IDE" width="800" style="box-shadow:0 4px 24px rgba(0,0,0,0.15);border-radius:16px;"/>
       <div style="font-size:1.1em;color:#555;margin-top:0.5em;"><em>ดาวน์โหลด Arduino IDE</em></div>
    </div>
...
2. ที่ช่อง **"Additional Boards Manager URLs"** ให้ใส่ URL นี้:
   ...
   ```
    <div align="center" style="margin: 2em 0;">
       ...
       <div style="font-size:1.1em;color:#555;margin-top:0.5em;"><em>เพิ่ม ESP32 Board URL</em></div>
    </div>
3. กด **OK**
...
2. ค้นหา "ESP32"
    <div align="center" style="margin: 2em 0;">
       <img src="Src/0002_installBoard_Esp32.png" alt="ติดตั้ง ESP32 Board" width="800" style="box-shadow:0 4px 24px rgba(0,0,0,0.15);border-radius:16px;"/>
       <div style="font-size:1.1em;color:#555;margin-top:0.5em;"><em>ติดตั้ง ESP32 Board</em></div>
    </div>
...
2. เลือกบอร์ดที่ต้องการใช้งาน เช่น "ESP32 Dev Module" หรือ "ESP32C3 Dev Module"
    <div align="center" style="margin: 2em 0;">
       <img src="Src/0003_choose_Esp32C3.png" alt="เลือกบอร์ด ESP32C3" width="800" style="box-shadow:0 4px 24px rgba(0,0,0,0.15);border-radius:16px;"/>
       <div style="font-size:1.1em;color:#555;margin-top:0.5em;"><em>เลือกบอร์ด ESP32C3</em></div>
    </div>
